...
class App extends Component {
  ...
  handlePayment(){
      ...
      fetch(`http://admin.cureassist.co/api/doctor/book/slot?id=${encodeURIComponent(slotid)}&appointment_date=${encodeURIComponent(date)}&doctor_id=${encodeURIComponent(doctor_id)}`,{
          method:"POST"
